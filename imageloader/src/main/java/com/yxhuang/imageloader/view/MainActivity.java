...
import com.yxhuang.imageloader.ImageLoader;
import com.yxhuang.imageloader.MyUtils;
import com.yxhuang.imageloader.R;
...
public class MainActivity extends Activity {
    ...
    private void initView() {
        ...
        mImageAdapter = new ImageAdapter(this, mData);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null){
                ...
                holder.imageView = (ImageView) convertView.findViewById(R.id.iv_grid_image);
